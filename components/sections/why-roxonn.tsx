...
const features = [
  {
    ...
    description: "Our unique decentralized structure ensures fair decision-making and empowers every team member."
  },
  {
    icon: <Coins className="w-12 h-12" />,
    title: "90% Revenue Share",
    description: "We believe in fair compensation, with 90% of project revenue going directly to our contributors."
  },
  {
    icon: <Lock className="w-12 h-12" />,
    title: "Complete Transparency",
    description: "Open access to project details, revenue distribution, and decision-making processes."
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Here&apos;s why you&apos;ll love contributing with us
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="text-[#00C2FF] flex-shrink-0">
                {feature.icon}
              </div>
              <div>
