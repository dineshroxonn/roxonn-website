...
const technicalContent = {
  ...
  cta: {
    ...
    description: "Lock your ROXN tokens to start earning enhanced rewards and gain more influence in governance decisions.",
...
const simpleContent = {
  ...
  cta: {
    ...
    description: "Lock your points today to earn bigger rewards and have more say in community decisions.",
